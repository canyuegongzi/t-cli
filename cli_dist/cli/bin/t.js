...
program.version("@canyuegongzi/t-cli ".concat(require('../../../package').version)).usage('<command> [options]');
program.command('init <app-name>').description('初始化一个工程').option('-c, --category <category>', '工程类型,[web | server]').option('-t, --template <template>', '模板名称').action(function (name, options) {
